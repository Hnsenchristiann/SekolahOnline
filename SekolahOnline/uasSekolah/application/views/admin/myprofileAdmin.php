<style>
    ...
    <div class="container">
        ...
        <div class="container2">
            ...
            <div class="card">
                <div class="additional">
                    <div class="layer">
                        <div class="user-card">
                            <img class="center" src="<?php echo base_url('assets/img/guru/') . $user['image']; ?>" style="border-radius:50%; width :100px; height:100px;">
                        </div>
                        <div class="more-info">
        ...
        <a class="btn btn-primary <?php if (!empty($datas)) echo 'disabled' ?>" href="<?php echo base_url('murid/editProfile'); ?>">Edit Profile</a>
    </div>
    <!-- /.container-fluid -->