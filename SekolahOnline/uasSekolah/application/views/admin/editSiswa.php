...
<form style="margin: 50px;" method="POST" action="<?php echo base_url('admin/editProfileSiswa') ?>" enctype="multipart/form-data">
    <div class="form-row">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="input-group-text">@siswa.com</div>
        </div>
    </div>
