...
<form style="margin: 50px;" method="POST" action="<?php echo base_url('admin/tambahGuruCreate') ?>" enctype="multipart/form-data">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="" placeholder="" name="lname" style="text-transform: capitalize;">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
